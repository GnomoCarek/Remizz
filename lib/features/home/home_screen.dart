...
import 'package:remizz/features/home/settings_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Músicas encontradas no seu dispositivo',
                          ...
                          child: ListTile(
                            ...
                            trailing: IconButton(
                              icon: Icon(
                                ...
                                color: isFavorite ? primaryColor : Colors.white38,
                              ),
                              onPressed: () {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Coloque arquivos MP3 na pasta de músicas do seu celular.',
          ...
          ElevatedButton(
            onPressed: () => ref.read(downloadedSongsProvider.notifier).refresh(),
            child: const Text('Escanear Dispositivo'),
          ),
        ],
      ),
    );
